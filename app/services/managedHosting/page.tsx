    ...
    return (
        <main className={serviceStyles.mainDiv} style={{ display: "grid", padding: "1rem" }}>
            <ShowServiceIntro
                ...
                text={
                    <>
                        Our Managed Hosting service provides a hassle-free solution for your hosting needs. We handle everything from domain management and business email setup to secure hosting environments and reliable contact form integrations. <br /><br /> With 24/7 monitoring and support, we ensure your website is always up and running smoothly, giving you peace of mind and allowing you to focus on your business.
                    </>
                } />
