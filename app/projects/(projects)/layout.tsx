...
import { Julius_Sans_One, Josefin_Sans, Lato, VT323 } from "next/font/google";
...
export default function ProjectsLayout({ children }: Readonly<{ children: React.ReactNode }>) {
    return (
        <ViewProjects className={`${JuliusSansOne.variable} ${JosefinSans.variable} ${lato.variable} ${albertExtraBold.variable} ${fakeReceipt.variable} ${vT323.variable} reset`}>
            {children}
        </ViewProjects>
    );
}
